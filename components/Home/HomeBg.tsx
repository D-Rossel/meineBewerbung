...
export function HomeBG () {
  ...
  return (
    <div className={`${styles.backgroundImage} ${isLight  ? "bg_Lightmode" : "bg_Darkmode"}`}>
      <div className={styles.contentContainer}>
        <div className={styles.textContainer}>
          ...
          <table className={styles.table}>
            ...
            <tbody>
              <tr>
                <td className={`${styles.td} ${isLight ? styles.tdLight : styles.tdDark}`}>Wiesbaden, Deutschland</td>
